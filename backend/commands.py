...
OVS_PATH = path.dirname(path.realpath(__file__))
...
def transpile_scss():
    with warnings.catch_warnings():
        ...
        with open(os.path.join(OVS_PATH, "static/scss/base.scss")) as scss:
            with open(os.path.join(OVS_PATH, "static/css/base.css"), "w") as css:
                css.write(compile_string(scss.read()))


def bundle_vendored():
    for getfiles, outputpath in [
        (get_js_vendored, os.path.join(OVS_PATH, "static/bundle.js")),
        (get_css_vendored, os.path.join(OVS_PATH, "static/bundle.css")),
    ]:
        output = ""
